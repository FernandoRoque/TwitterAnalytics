...
api_key <-  "yO6Pi73ZQJm4yPbVMMAOjjmc9"
api_secret <- "JoXNo54yP4kJe6Ve7okz5FaRlmvYsegkLp2RmNgo7rqTc1tIwz"

set.key("AIzaSyAUelN2z_F7PlvtA7QaT0jfxChENPxnLnk")

setup_twitter_oauth(api_key, api_secret, "840209853658345475-0DrxFFwukfGg2kNquECOlBV8aeOZUli", "OP3q62dA6AlDaNfSy98fcBFdNwKe2o8INndWfaT7EwIFz")


navbarPage("Twitter Analytics", inverse = TRUE,
                 ...
                 tabPanel("Welcome",
                          ...
                          HTML('<br/>'), 
                             h4(p(strong("Tweets Table"), "and", strong("Word Cloud"), "features visualize a 
           ...
           navbarMenu("Tweets Table",
                      tabPanel("User Tweets",
                               sidebarLayout(
                                 sidebarPanel(width = 3,
                                              ...
                                              div(style="display: inline-block;vertical-align:right; width: 150px;",
                                                  textInput("twitterUser1", "Enter User", "hadleywickham")),
                                              
                                              div(style="display: inline-block;vertical-align:right; width: 80px;",
                      ...
                      tabPanel("User Favorites",
                               sidebarLayout(
                                 sidebarPanel(width = 3,
                                              
                                              tags$style(HTML(".tabbable > .nav > li > a[data-value='User Favorites'] {background-color: #333333;   color:white}")),
                                              
                                              div(style="display: inline-block;vertical-align:right; width: 140px;",
                                                  textInput("twitterUser2", "Enter User", "hadleywickham")),
                                              
                                              div(style="display: inline-block;vertical-align:right; width: 70px;",
           ...
           navbarMenu("Tweet Statistics",
                      tabPanel("User Tweets",
                               sidebarLayout(
                                 sidebarPanel(
                                   textInput("twitterUser4", "Enter User", "askdrstats"),
                                   selectInput("chooseTime_Platform1", "Horizontal axis:", choices = c('Hour' = 'hour', 'Weekday' = 'weekday', 'Month' = 'month',
                                                                                                       'Year' = 'year', 'Platform' = 'platform')),
                                   selectInput("chooseTime_Platform2", "Vertical axis:", choices = c('Weekday' = 'weekday', 'Hour' = 'hour', 'Month' = 'month',
                                                                                                     'Year' = 'year', 'Platform' = 'platform')),
                      ...
                      tabPanel("User Favorites",
                               sidebarLayout(
                                 sidebarPanel(
                                   ...
                                   selectInput("chooseTime_Platform1_fav", "Horizontal axis:", choices = c('Hour' = 'hour', 'Weekday' = 'weekday', 'Month' = 'month',
                                                                                                           'Year' = 'year', 'Platform' = 'platform')),
                                   selectInput("chooseTime_Platform2_fav", "Vertical axis:", choices = c('Weekday' = 'weekday', 'Hour' = 'hour', 'Month' = 'month',
                                                                                                         'Year' = 'year', 'Platform' = 'platform')),
                      ...
                      tabPanel("Topic Tweets",
                               sidebarLayout(
                                 sidebarPanel(
                                   ...
                                   selectInput("chooseTime_Platform1_topic", "Horizontal axis:", choices = c('Hour' = 'hour', 'Weekday' = 'weekday', 'Month' = 'month',
                                                                                                             'Year' = 'year', 'Platform' = 'platform')),
                                   selectInput("chooseTime_Platform2_topic", "Vertical axis:", choices = c('Weekday' = 'weekday', 'Hour' = 'hour', 'Month' = 'month',
                                                                                                           'Year' = 'year', 'Platform' = 'platform')),
           ...
           navbarMenu("Word Cloud",
                      tabPanel("User Tweets",
                               sidebarLayout(
                                 ...
                                 mainPanel(
                                   tabsetPanel(
                                     tabPanel("User Tweets", plotOutput("userTweetsCloud", height = "700px"),
                                              plotlyOutput("userTweetsCloudTab", height = "800px"))), width = 9)
                               )
                      ),
                      tabPanel("User Favorites",
                               sidebarLayout(
                                 ...
                                 mainPanel(
                                   tabsetPanel(
                                     tabPanel("User Favorites", plotOutput("userFavoritesCloud", height = "500px"),
                      ...
                      tabPanel("Topic Tweets",
                               sidebarLayout(
                                 sidebarPanel(width = 3,
                                              ...
                                              div(style="display: inline-block;vertical-align:right; width: 60px;",
                                 ...
                                 mainPanel(
                                   tabsetPanel(
                                     tabPanel("Topic Tweets", plotOutput("tweetTopicCloud", height = "700px"),
           ...
           navbarMenu("Geographic Analysis",
                      tabPanel("Mapping Trends",
                               (bootstrapPage(
                                 leafletOutput("map"),
                      ...
                      tabPanel("Mapping Following",
                               sidebarLayout(
                                 sidebarPanel(width = 3,
                                              ...
                                              actionButton("showFollowingMap", "Show Mapped Follwing", 
                      ...
                      tabPanel("Mapping Followers",
                               sidebarLayout(
                                 sidebarPanel(width = 3,
                                              ...
                                              actionButton("showFollowerMap", "Show Mapped Followers", 
                                                           style="color: #000000;background-color: #00aced;"
                                              ),
                      ...
                      tabPanel("Mapping Tweets",
                               sidebarLayout(
                                 sidebarPanel(
                                   ...
                                   selectInput("circleCount", "Circle radius by:", choices = c('RetweetCount' = 'retweetCount',
                                                                                               'FavoriteCount' = 'favoritesCount', 'FollowerCount' = 'followersCount',
                                                                                               'FriendsCount' = 'friendsCount', 'StatusCount' = 'statusesCount')),
                                   selectInput("circleColor", "Color by:", choices = c('Hour' = 'hour', 
                                                                                       'Weekday' = 'weekday'
                                   )),
